...
def scan_ball(cam):
    ...
    # ret3, threshold_grayscale = cv2.threshold(blur,0,255,
    ...
    for contour in contours:
        ...
        if x > 100 and y > 100 and x < 600 and y < 400 and radius > 20 and radius < 150 and area_to_radius_ratio > math.pi*radius*circle_ratio and area > 10:
